...
window.onresize = function(event) {
    ...
    Event.$emit('changeWidth',$(window).width())
    if ($(window).width()<800) {

        //$sidebar.removeClass('open');
        /*  $('.content').css('margin-right','0px')
          $('.right-sidebar').css('top','67px')
          $('.sidebar').css('top','46px')*/
    }
    else{

        /*$sidebar.addClass('open');*/
        /* $('.content').css('margin-right','345px')
         $('.right-sidebar').css('top','90px')
