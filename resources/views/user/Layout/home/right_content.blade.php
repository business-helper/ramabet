...
<div id="tabs" style="height: 78%;">
    ...
    min-height: 100px;overflow-y: auto;height: 100%">
        ...
        <div id="openbet" class="tab-pane fade">
            ...
            <div id="collapseTwo" class="placedbets collapse in show" style="background: rgb(255, 255, 255);  font-size: 12px;">
                {{--<placedbets time_status="0"></placedbets>--}}
            </div>
            ...
            <div id="collapseThree" class="placedbets collapse in show" style="background: rgb(255, 255, 255); font-size: 12px;">
                <placedbets time_status="1"></placedbets>
            </div>
        </div>
    </div>
</div>