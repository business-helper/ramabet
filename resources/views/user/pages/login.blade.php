...
<head>
    ...
    <style>
        .back_image{background: url("{{asset('img/'.$general_setting['admin_image'])}}") center;background-size: cover;}
    </style>
</head>

<body style="" class="back_image">
    <!--[if lt IE 8]>
	...
	<div class="error-pagewrap">
		<div class="error-page-int">
			...
			<div class="content-error">
				<div class="hpanel">
                    <div class="panel-body" style="opacity: 0.9;">
                        <form method="POST" role="form" action="{{ route('login') }}" id="loginForm">
                            {{ csrf_field() }}
			...
			<div class="text-center login-footer">
                <img height="50px" src="{{asset('/img/logo-skyexchange.png')}}">
			</div>
		</div>   
    </div>
    <!-- jquery
