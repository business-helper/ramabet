                    ...
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="javascript:void(0);" class="add_master">Add Distributor</a></li>
                                    ...
                                    <td>
                                        ...
                                        <ul class="" style="float: right; margin: -5px 0; padding: 0;">
                                            <li class="dropdown" style="list-style: none">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li><a href="{{url('admin/admin_state/'.$item->id.'/normal')}}">normal</a></li>
                                                    <li><a href="{{url('admin/admin_state/'.$item->id.'/block')}}">block</a></li>
                                                    <li><a href="{{url('admin/admin_state/'.$item->id.'/delete')}}">delete</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
...
@section('script')
    ...
    <script>
        ...
        function EditMaster(item) {
            ...
            $('#add_master_dlg .modal-header .modal-title').text('Update Distributor');
        ...
        $('.add_master').click(function () {
            ...
            $('#add_master_dlg .modal-header .modal-title').text('Add Distributor');
