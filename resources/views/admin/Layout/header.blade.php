                                            ...
                                            <div role="menu" class="notification-author dropdown-menu animated zoomIn" style="max-height: 350px;overflow: auto;">
                                                ...
                                                <ul id="notification" class="notification-menu">
                                                    @foreach(auth('admin')->user()->unreadNotifications as $notification)
                                                        <li id="{{$notification->id}}" style="display: list-item" onclick="markNotificationAsRead('{{$notification->id}}')">
                                                            <a href="#">
                                                                ...
                                                                <div class="notification-content">
                                                                    @php
                                                                        $dt=new DateTime($notification->repliedTime['date']);
                                                                    @endphp
                                                                    <span class="notification-date">{{$dt->format('Y-m-d H:i:s')}}</span>
                                                                    <h2>{{$notification->data['sender']['name']}}</h2>
                                                                    <p>{{$notification->data['content']['message']}}</p>
                                                                </div>
                                                            </a>
                                                        </li>
                                                    @endforeach
