            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group-inner">
                        ...
                        <input id="sports_id" type="hidden" class="form-control" placeholder="Enter Sport Id" />
                    </div>
                    <div class="form-group-inner">
                        <label>Title</label>
...
@section('script')
    ...
    <script>
        $('.add_sports').click(function () {
            $('#PrimaryModalhdbgcl #sports_edit_type').text('insert');
            $('#PrimaryModalhdbgcl #change_odd').text('Submit');
            $('#PrimaryModalhdbgcl').modal();
        });
        function EditSport(sports) {
            console.log(sports.id);
            $('#PrimaryModalhdbgcl #sports_id').val(sports.id);
            $('#PrimaryModalhdbgcl #sports_name').val(sports.name);
            $('#PrimaryModalhdbgcl #sports_edit_type').text('update');
        ...
        $('#change_odd').click(function () {
            ...
            var send_data={};
            send_data.type= $('#PrimaryModalhdbgcl #sports_edit_type').text();
            send_data.table_name= 'news';
            //send_data.data=[];
            send_data.data={
            ...
            send_data.condition=[];
            send_data.condition.push(['id',$('#PrimaryModalhdbgcl #sports_id').val()]);
            //console.log(typeof send_data,JSON.stringify(send_data));
            myajax('https://odds24ex.com/api/table_edit',send_data,true);
        });
    </script>
