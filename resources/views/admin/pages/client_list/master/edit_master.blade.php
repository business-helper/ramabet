                    ...
                    <div class="product-payment-inner-st">
                        <div id="myTabContent" class="tab-content custom-product-edit">
                            <div class="product-tab-list tab-pane fade active in" id="reviews">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <form action="{{action('AdminController@update_subadmin')}}" class="review-content-section" method="post">
                                            {{csrf_field()}}
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="devit-card-custom">
                                                        <div class="form-group">
                                                            <input type="hidden" name="id" class="form-control" placeholder="Name" value="{{$user->id}}">
                                                            <label>Name</label>
                                                        ...
                                                        {{--<div class="form-group">--}}
                                                            {{--<label>Wallet</label>--}}
                                                            {{--<input name="wallet" type="number" class="form-control" placeholder="Wallet" value="{{$user->wallet}}">--}}
                                                        {{--</div>--}}
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            ...
            $('.breadcome-menu').append('' +
                ...
                '</li>' +
                '<li>' +
                '<span class="bread-blod">Masters</span>\n' +
                '</li>');
        });
