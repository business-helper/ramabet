...
<div class="container">
    <div class='row' style="padding-top:100px">
        ...
        <div class='col-sm-6'>
            ...
            <form accept-charset="UTF-8" action="{{url('/strippay')}}" class="require-validation"
                  data-cc-on-file="false"
                  data-stripe-publishable-key="pk_test_nAMPuNcRMPhTBmHfZT1qYFhF"
                ...
                <div class='form-row'>
                    <div class='col-sm-12'>
                        <div class='form-group expiration required'>
                            ...
                            <input
                                    class='form-control card-expiry-year' placeholder=''
                                    size='4' type='text' name="amount">
                        </div>
                    </div>
                </div>
                <div class='form-row'>
