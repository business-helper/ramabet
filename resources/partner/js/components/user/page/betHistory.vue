                ...
                <div class="card">
                    ...
                    <div class="date_filter header">
                        ...
                        <select class="form-control" v-model="bet_type" name="type">
                            ...
                            <option value="availableToLay">Lay</option>
                            <option value="availableToBack">Back</option>
                        </select>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <tr v-for="bh in betHistory" v-bind="bh">
                                        <td>{{bh.id}}</td>
                                        <td>{{bh.runnerName}}</td>
                                        <td>{{bh.odd}}</td>
                                        <td>{{bh.stake}}</td>
    ...
    export default {
        ...
        methods: {
            ...
            read() {
                ...
                window.axios.post('/api/bethistory', {start_date: this.start_date, search: this.search, odd: this.odd, bet_type: this.bet_type, end_date: this.end_date, stake: this.stake, state: this.state, ip: this.ip, user_id: userID}).then((res) => {
