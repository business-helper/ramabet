<template>
    <div class="container-fluid" style="padding-bottom: 200px;padding-top: 40px">
        <div class="row">
            <eventdetail :market_id="this.$route.params.event_id"></eventdetail>
            <betslipNew></betslipNew>
        </div>
        <markets :market_id="this.$route.params.event_id"></markets>
    </div>
</template>
...
<script>
    export default {
        ...
        created(){
            //this.getBaner();
            Event.$emit('leftmarkets', this.$route.params.event_id);
        }
    }
</script>
