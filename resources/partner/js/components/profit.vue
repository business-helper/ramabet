...
<script>
    export default {
        ...
        props: [
            'runner_id','state1','market_id','initProfit'
        ],
        mounted() {
        ...
        methods:{
            read() {
                ...
                this.newProfit=0;
                window.axios.post('/api/getProfitAdmin',{runner_id:this.runner_id,user_id:this.$userId,market_name:this.market_name}).then(({ data }) => {
