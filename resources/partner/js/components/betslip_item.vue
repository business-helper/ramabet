...
<template>
    <div style="padding: 5px" class="betslip_item">
        <div style="text-align: left;padding-left: 10px">
            ...
            <span>({{this.bet_type_name}})</span></div>
            ...
            <div class="backSlipHeader" style="display: flex;width: 100%;justify-content: space-around;height:60px;">
                ...
                <div class="item20" style="width: 100%;">
                    ...
                    <div class="item20" style="padding-right: 5px;width: 100%;height: 35px;display: flex;justify-content: space-between;">
                        <span class="fa fa-minus btn bg-red waves-effect" style="font-size: 29px;padding: 3px;" @click="desodds"></span>
                        ...
                        <span class="fa fa-plus btn bg-light-green waves-effect" style="font-size: 29px;padding: 3px;background: #aade12;" @click="incodds"></span>
                    </div>
                </div>
                <div class="item20" style="width: 100%;">
                    <div style="padding-left:10px;width: 100%;text-align: left">Stake</div>
                    <div class="item20" style="padding-left: 5px;width: 100%;height: 35px;display: flex;justify-content: space-between;">
                        <span class="fa fa-minus btn bg-red waves-effect" style="font-size: 29px;padding: 3px;" @click="desstake"></span>
                        ...
                        <span class="fa fa-plus btn bg-light-green waves-effect" style="font-size: 29px;padding: 3px;background: #aade12;" @click="incstake" ></span>
                    </div>
                </div>


                <!--<div style="align-self: center; flex: 1; text-align: right;">-->
                    <!--<div class="btn btn-danger betslip_close" @click="del()"><i class="fas fa-times"></i></div>-->
                <!--</div>-->
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            calculate(){
                ...
                // console.log(this.bet_type_name);
            ...
            setOdd(val){
                this.stake_local=parseFloat(val);
                this.calculate()
            }
        },
        created(){
