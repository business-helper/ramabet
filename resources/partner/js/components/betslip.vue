        ...
        <div id="betSlipFooter" :class="show_footer">
            ...
            <div >
                <div style="text-align: left;padding-left:5px;">
                    ...
                    <!--<input id="confirm" v-model="is_confirm" type="checkbox">-->
    ...
    export default {
        ...
        methods:{
            ...
            create(data){
                ...
                this.is_show_footer = false;
                console.log(data);
                if(data.market_id == this.market_id){
                    this.mute = true;
                    //this.betslip = [];
                    this.is_show_footer = true;
                    this.show_footer='show';
            ...
            confirm_betslip(item) {
                window.axios.post('/api/confirmBetSlip',{id:item.id,odd:item.odd,stake:item.stake }).then(({ data }) => {
                    if (data.state==0){
            ...
            placeBets_all(){
                if (this.is_confirm==false){
                    showNotification("alert-success",'Please confirm your bets.' , "bottom", "right", "animated lightSpeedIn", "animated lightSpeedOut");
                }
                else{
                    for (var i=0;i<this.betslips.length;i++){
