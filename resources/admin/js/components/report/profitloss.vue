        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Profit And Loss Report <span v-if="this.userName!=''">of {{this.userName}}</span>
                        </h2>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            read() {
                ...
                window.axios.post('/api/getReport', {reportType:'P|L', end_date: this.end_date, user_id:this.user_id, user_type: this.user_type}).then((res) => {
