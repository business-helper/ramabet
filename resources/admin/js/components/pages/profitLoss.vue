    ...
    export default {
        ...
        methods: {
            filter(){
                ...
                window.axios.post('/api/profitOfUser', {start_date: this.start_date, sport: this.sport, end_date: this.end_date, event_name: this.event_name, user_id: this.$route.params.user_id,type:this.$route.params.type}).then((res) => {
