    ...
    <div class="sticky-tabs">
        ...
        <div class="tab-content match-tabs-content">
            ...
            <div id="liveStatus" class="tab-pane fade">
                <div class="box box-primary Dcursor" tabindex="1">
                    <div class="box-body" style="text-align: center;width: min-content">
                        ...
                        <iframe class="player" frameborder="0" width="334" height="290"
                                scrolling="no" :key="this.event_id"
                                :src="'https://videoplayer.betfair.com/GetPlayer.do?tr=1&eID='+this.event_id+'&width=334&height=290&contentType=viz&contentOnly=false&contentView=mstats&statsToggle=hide'"></iframe>
                    </div>
                </div>

            </div>
            <div id="userPosition" class="tab-pane fade">
                <p style="font-size: 12px;font-weight: 600;text-align: center" v-if="total_count==0">There are No Open
                    bets yet</p>
                <div v-else>
                    <div v-if="this.total_count!==0" class="panel-group full-body" id="userPosition_div" role="tablist"
                         aria-multiselectable="true" style="margin-bottom: 5px;">
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="userPosition_tab"
                                 style="background-color: #082a49; color: white;">
                                <span class="panel-title" style=" text-align: left; padding: 0; font-size: 16px;">
                                    <a role="button" data-toggle="collapse" href="#userPosition_tab_col"
                                       aria-expanded="false" aria-controls="userPosition_tab_col" class="collapsed"
                                       style="    padding: 0px 15px;">
                                        User Position1 [{{this.markets.length}}]
                                    </a>
                                </span>
                            </div>
                            <div id="userPosition_tab_col" class="panel-collapse collapse in" role="tabpanel"
                                 aria-labelledby="unmatched_tab_col" aria-expanded="true">
                                <div class="panel-body" style="padding: 0">
                                    <button style="padding: 0; width: 50px; float: right;"
                                            class="btn btn-success waves-effect waves-circle waves-float"
                                            name="result_session" @click="backPosition">Back
                                    </button>
                                    <select v-if="markets.length!==0" class="form-control show-tick"
                                            @change="ChangeMarketOfPosition" style="width: 300px">
                                    ...
                                    <table class="table table-bordered table-condensed" style="margin: 0;">
                                        ...
                                        <tr style="color: #585858">
                                            <th style="">User</th>
                                            <th v-for="item in runners[c_marketForPosition]" style="">
                                                {{item.runnerName}}
                                            </th>
                                        </tr>
                                        </thead>
                                        ...
                                        <tr v-for="item in userPosition[c_marketForPosition]">
                                            <td>
                                                <a v-if="item.account.type=='admins'"
                                                   @click="getUserPosition(item.account.id)">
                                                    {{item['account']['name']}}
                                                </a>
                                                <span v-else>
                                                    {{item['account']['name']}}
            ...
            <div id="scorePos" class="tab-pane fade active in">
                ...
                <p style="font-size: 12px;font-weight: 600;text-align: center" v-if="total_count+fancyBets.length==0">
                    There are No Open bets yet</p>
                <div v-else>
                    <select v-if="total_count!==0" class="form-control show-tick" @change="ChangeMarket"
                            v-model="c_market">
                        <option value="0">All({{this.total_count}})</option>
                        <option v-for="item in this.markets" v-bind:value="item.id">
                            {{item.eventName}}-{{item.marketName}}({{item.count}})
                        </option>
                    </select>
                    <div v-if="this.placedBetsOfUnMatched.length!==0" class="panel-group full-body" id="dvUnMBeat"
                         role="tablist" aria-multiselectable="true" style="margin-bottom: 5px;">
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="unmatched_tab"
                                 style="background-color: #082a49; color: white;">
                                <span class="panel-title" style=" text-align: left; padding: 0; font-size: 16px;">
                                    <a role="button" data-toggle="collapse" href="#unmatched_tab_col"
                                       aria-expanded="false" aria-controls="unmatched_tab_col" class="collapsed"
                                       style="    padding: 0px 15px;">
                                        Unmatched Bets <b id="UnMatCount">[{{this.placedBetsOfUnMatched.length}}]</b>
                                    </a>
                                </span>
                            </div>
                            <div id="unmatched_tab_col" class="panel-collapse collapse in" role="tabpanel"
                                 aria-labelledby="unmatched_tab_col" aria-expanded="true">
                                <div class="panel-body" style="padding: 0">
                                    <table id="tbUnMatched" class="table table-bordered table-condensed"
                                           style="margin: 0;">
                                        <thead>
                                        <tr style="color: #585858">
                                            <th style="">del</th>
                                        ...
                                        <tr v-for="item in this.placedBetsOfUnMatched" :class="item.bet_type">
                                            ...
                                            <td>
                                                <div class="btn btn-danger betslip_close right" @click="del(item.id)"><i
                    ...
                    <div v-if="this.placedBetsOfMatched.length!==0" class="panel-group full-body" id="" role="tablist"
                         aria-multiselectable="true">
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="matched_tab"
                                 style="background-color: #082a49; color: white;">
                                <span class="panel-title" style=" text-align: left; padding: 0; font-size: 16px;">
                                    <a role="button" data-toggle="collapse" href="#matched_tab_col"
                                       aria-expanded="false" aria-controls="collapseOne_21" class="collapsed"
                                       style="    padding: 0px 15px;">
                                        Matched Bets
                            ...
                            <div id="matched_tab_col" class="panel-collapse collapse in" role="tabpanel"
                                 aria-labelledby="unmatched_tab_col" aria-expanded="true">
                                <div class="panel-body" style="padding: 0">
                                    <table id="tbMatched"
                                        ...
                                        <tr style="color: #585858" role="row">
                                            ...
                                            <th style="" class="sorting_disabled"
                                                rowspan="1" colspan="1">Runner
                                            </th>
                                            <th style="" class="sorting_disabled"
                                                rowspan="1" colspan="1">Odds
                                            </th>
                                            <th style="" class="sorting_disabled"
                                                rowspan="1" colspan="1">Stake
                                            </th>
                                            <th style="" class="sorting_disabled"
                                                rowspan="1" colspan="1">Side
                                            </th>
                                            <th style="" class="sorting_disabled"
                    ...
                    <p style="font-size: 12px;font-weight: 600;text-align: center" v-else>There are No Matched bets
                        yet</p>
                    <p style="font-size: 12px;font-weight: 600;text-align: center" v-if="fancyBets.length==0">There are
                        No Fancy bets yet</p>
                    <div v-else>
                        <div class="panel-group full-body" role="tablist" aria-multiselectable="true">
                            <div class="panel">
                                <select v-if="fancy_runners.length!==0" class="form-control show-tick"
                                        v-model="c_fancy">
                                    <option value="0">All</option>
                                    <option v-for="item in this.fancy_runners" v-bind:value="item.id">
                                        {{item.eventName}}-{{item.runnerName}}
                                    </option>
                                </select>

                                <div class="panel-heading" role="tab" id="fancy_tab"
                                     style="background-color: #082a49; color: white;">
                                <span class="panel-title" style=" text-align: left; padding: 0; font-size: 16px;">
                                    <a role="button" data-toggle="collapse" href="#fancy_tab_col" aria-expanded="false"
                                       aria-controls="collapseOne_21" class="collapsed" style="    padding: 0px 15px;">
                                        Fancy Bets
                                        <b>[{{this.fancyBets.length}}]</b>
                                    </a>
                                </span>
                                </div>
                                <div id="fancy_tab_col" class="panel-collapse collapse in" role="tabpanel"
                                     aria-labelledby="fancy_tab_col" aria-expanded="true">
                                    <div class="panel-body">
                                        ...
                                        <table class="table table-bordered table-condensed" style="margin: 0;">
                                            ...
                                            <tr v-for="item in this.fancyBets" :class="item.bet_type"
                                                v-if="item.runner_id==c_fancy || c_fancy==0">
            ...
            <div id="scoreBook" class="tab-pane fade">
                <!-- Div score position There are No Open bets yet-->
                <p style="font-size: 12px;font-weight: 600;text-align: center" v-if="scoreBook.length==0">There are No
                    Fancy bets yet</p>
                <div v-else>
                    <div class="panel-group full-body" role="tablist" aria-multiselectable="true">
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="scoreBook_tab"
                                 style="background-color: #082a49; color: white;">
                                <span class="panel-title" style=" text-align: left; padding: 0; font-size: 16px;">
                                    <a role="button" data-toggle="collapse" href="#fancy_tab_col" aria-expanded="false"
                                       aria-controls="collapseOne_21" class="collapsed" style="    padding: 0px 15px;">
                            ...
                            <div id="scoreBook_tab_col" class="panel-collapse collapse in" role="tabpanel"
                                 aria-labelledby="fancy_tab_col" aria-expanded="true">
    ...
    export default {
        data() {
            return {
                ...
                matchedOddMarkets: [],
                exposureOfAccounts: [],
                c_marketForPosition: 0,
                userPosition: [],
                posHis: [],
                runners: [],
                event_id: this.event_import_id,
                c_market: 0,
                scoreBook: [],
                fancyBets: [],
                runnerName: '',
