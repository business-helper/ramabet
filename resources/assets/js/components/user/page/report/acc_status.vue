                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover boldFontTAble">
                                ...
                                <tr>
                                    <td>Wallet</td>
                                    <td>
                                        <span v-if="this.user.wallet-this.user.exposure>=0" style="color: green">
                                            {{(this.user.wallet-this.user.exposure).toFixed(2)}}
                                        </span>
                                        <span v-else style="color:red;">
                                            {{(this.user.wallet-this.user.exposure).toFixed(2)}}
                                        </span>
                                ...
                                <tr>
                                    <td>Liability</td>
                                    <td>
                                        <span v-if="this.user.exposure>=0" style="color: green">
                                            {{(this.user.exposure).toFixed(2)}}
                                        </span>
                                        <span v-else style="color:red;">
                                            {{(this.user.exposure).toFixed(2)}}
                                        </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span v-if="this.user.pAndL+this.user.comAmount+this.user.cash>=0" style="color: green">
