    ...
    <div class="home_event" style="">
        <div style="padding: 4px 8px;flex:1;">
            <div style="display: flex;height: 100%">
                ...
                <router-link :to="'/event/'+event_data.event.id" style="align-self: center;">
...
<script>
    ...
    export default {
                ...
                switch (r_data.id) {
                    case this.home.id:
                        ...
                        if (r_data.type=='availableToBack'){
                            ...
                            this.home.availableToBack=r_data.availableToBack;
                        }
                        else{
                            //this.home_lay_update='livenow';
                            this.home.availableToLay=r_data.availableToLay;
                        }
                        break;
                    case this.away.id:
                        //this.away=r_data[r_data.type];
                        if (r_data.type=='availableToBack'){
                            //this.away_back_update='livenow';
                            this.away.availableToBack=r_data.availableToBack;
                        }
                        else{
                            //this.away_lay_update='livenow';
                            this.away.availableToLay=r_data.availableToLay;
                        }
                        break;
                    case this.draw.id:
                        //this.draw=r_data[r_data.type];;
                        if (r_data.type=='availableToBack'){
                            //this.draw_back_update='livenow';
                            this.draw.availableToBack=r_data.availableToBack;
                        }
                        else{
                            //this.draw_lay_update='livenow';
                            this.draw.availableToLay=r_data.availableToLay;
        ...
        methods:{
            read() {
                this.market_state=this.event_data.multi;
